...
const ARTY_A7_35T_BUTTONS: BoardPin[] = [
  {
    name: "ArtyA735T_GPIO_Button_CPU_Reset",
    signal: "cpu_reset",
    pin: "C2",
    type: "button",
...
const ARTY_A7_35T_PINS: BoardPin[] = [
  ...
  ...ARTY_A7_35T_BUTTONS,
  {
    name: "ArtyA735T_SystemClock_100MHz",
    signal: "sys_clk",
    pin: "E3",
    type: "clock",
    group: "System Clock",
  ...
  {
    name: "ArtyA735T_SPI_SerialClock",
    signal: "spi_sck",
    pin: "F1",
    type: "spi",
    group: "SPI Header",
  ...
  {
    name: "ArtyA735T_SPI_SlaveSelect",
    signal: "spi_ss",
    pin: "C1",
    type: "spi",
    group: "SPI Header",
